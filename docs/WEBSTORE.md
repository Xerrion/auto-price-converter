...
This document contains the official Chrome Web Store listing content for Auto Price Converter.
...
Automatically converts prices on any website to your local currency using live exchange rates. Supports 38 source currencies.
...
• Dynamic Content — Works with infinite scroll, AJAX-loaded content, and single-page apps
• Customizable Display — Show original prices, highlight conversions, adjust decimal places
• Multiple Number Formats — US (1,234.56), European (1.234,56), French (1 234,56), Swiss (1'234.56)
...
1. Popup Interface — Quick toggle and currency selection right from your toolbar
2. Price Conversion — See converted prices directly on any website
3. Options Page — Customize display format, decimal places, and more
4. Dark Mode — Full dark mode support for comfortable browsing

## Promotional Tile Text (if needed)

Auto Price Converter
See any price in your currency — automatically.
